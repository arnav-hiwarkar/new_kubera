...
async def test_activity_log_cross_tenant_leak(client: AsyncClient):
    ...
    # Create company A
    await create_test_company(client, name="CompA", email="a@a.com", password="Valid1!Pass")
    token_a = await get_company_token(client, email="a@a.com", password="Valid1!Pass")

    # Create company B
    await create_test_company(client, name="CompB", email="b@b.com", password="Valid1!Pass")
    token_b = await get_company_token(client, email="b@b.com", password="Valid1!Pass")
...
async def test_notification_cross_tenant_leak(client: AsyncClient):
    ...
    data_a = await create_test_company(client, name="A", email="a@a.com", password="Valid1!Pass")
    token_a = await get_company_token(client, email="a@a.com", password="Valid1!Pass")

    data_b = await create_test_company(client, name="B", email="b@b.com", password="Valid1!Pass")
    token_b = await get_company_token(client, email="b@b.com", password="Valid1!Pass")
