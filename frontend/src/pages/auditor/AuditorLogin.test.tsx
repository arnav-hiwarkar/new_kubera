...
describe('AuditorLogin Rate Limit', () => {
  it('displays the parsed Retry-After header as minutes on 429 response', async () => {
    // 61 seconds = 2 minutes (Math.ceil)
    installFetchMock(429, { 'Retry-After': '61' })
    renderApp('/auditor/login')
    ...
    expect(await screen.findByText('Too many attempts. Please try again in 2 minutes.')).toBeInTheDocument()
  })
