  ...
  return (
    ...
    >
      <fieldset className="rounded-card border border-border p-4">
        ...
        {/* Schedule II permits a different life but requires the reason to be
            disclosed, so the field appears exactly when it becomes mandatory. */}
        {lifeDiffers && (
          <Field
            className="mt-3"
          ...
          <Field label="Asset block" required>
            <Select
              ...
              onChange={(e) => {
                ...
                set('it_block_id', id)
                // Keep the rate in step with the block, since the statutory rate is
                // a property of the block, not a free choice.
        ...
        <label className="flex items-start gap-2 text-sm text-text-secondary">
          ...
          <span>
            ...
            <span className="block text-xs text-text-muted">
              ...
              recomputed from the capitalization date — a block's tax WDV cannot be
              reconstructed per asset.
            </span>
          </span>
        </label>
      ...
      <Card className="p-4">
        <h4 className="mb-2 text-sm font-semibold text-text-primary">Derived</h4>
        ...
        <p className="mt-3 border-t border-border pt-3 text-xs text-text-muted">
          Period depreciation, accumulated depreciation, net book value and closing tax
          WDV are produced by the depreciation engine once a financial year is set up.
        </p>
      </Card>
    </SectionShell>
  )
