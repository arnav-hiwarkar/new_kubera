  ...
  return (
    <>
      <div
        ...
        className="absolute top-18 right-4 w-96 max-h-[calc(100vh-6rem)] overflow-y-auto rounded-2xl border border-border bg-bg-surface/95 backdrop-blur-md shadow-2xl p-4.5 z-30 flex flex-col gap-4.5"
      >
        {/* Header */}
        ...
        {/* Creator / Uploader / Updated metadata */}
        <div className="flex flex-wrap items-center gap-x-2 gap-y-1 text-xs text-text-secondary">
          <span className="inline-flex min-w-0 max-w-full items-center gap-1">
            ...
            <span
              ...
              title={document.created_by_name ?? 'Unknown'}
            >
          ...
          {document.updated_at && (
            <>
              <span className="shrink-0 text-text-muted">·</span>
              <span className="inline-flex min-w-0 max-w-full items-center gap-1">
                <span className="shrink-0 text-text-muted">Updated</span>
